...
public class SinglyLinkedListTest {
    ...
    //
    // assertEquals(true, doReverse(new SinglyLinkedList(twoElems), twoElems,
    // twoElemsReversedPairs));
    //
    // assertEquals(true, doReverse(new SinglyLinkedList(threeElems), threeElems,
    // threeElemsReversedPairs));
    //
    // assertEquals(true, doReverse(new SinglyLinkedList(oddElems), oddElems,
    // oddElemsReversedPairs));
    //
    // assertEquals(true, doReverse(new SinglyLinkedList(evenElems), evenElems,
    // evenElemsReversedPairs));
    //
    // }
    //
